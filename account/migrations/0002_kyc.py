    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity_type', models.CharField(choices=[('national_id_card', 'National ID Card'), ('adhar_card', 'Adhar Card'), ('international_passport', 'International Passport')], max_length=140)),
