    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_id', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=7, max_length=25, prefix='PEX', unique=True)),
                ('pin_number', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=4, max_length=7, prefix='', unique=True)),
                ('red_code', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh1234567890', length=10, max_length=10, prefix='', unique=True)),
                ('account_status', models.CharField(choices=[('in-active', 'In-Active'), ('active', 'Active')], default='in-active', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity_type', models.CharField(choices=[('adhar_card', 'Adhar Card'), ('driving_licience', 'Driving Licence'), ('international_passport', 'Innternational Passport')], max_length=140)),
