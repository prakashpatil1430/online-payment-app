...
def withdraw_fund(request, card_id):
    ...
    if request.method == "POST":
        ...
        if 0 < amount <= credit_card.amount:
            ...
            return redirect("cards:card-detail", credit_card.card_id)
        else:
...
def delete_card(request, card_id):
    ...
    # New Feature
    """
    BEfore deleting card, it'll be nice to transfer all the money
    from the card to the main account balance.
    """
